...
```sh
npx github:collod873/claude-ds#v1.2.0
```
...
npx github:collod873/claude-ds#v1.2.0 init --pack next-react

# Brownfield — adopt into an existing project
npx github:collod873/claude-ds#v1.2.0 adopt --pack next-react
```
