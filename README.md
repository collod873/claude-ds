...
```sh
npx github:collod873/claude-ds#v1.5.2
```
...
npx github:collod873/claude-ds#v1.5.2 init --pack next-react

# Brownfield — adopt into an existing project
npx github:collod873/claude-ds#v1.5.2 adopt --pack next-react
```
