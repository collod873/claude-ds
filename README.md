...
```sh
npx github:collod873/claude-ds#v1.5.3
```
...
npx github:collod873/claude-ds#v1.5.3 init --pack next-react

# Brownfield — adopt into an existing project
npx github:collod873/claude-ds#v1.5.3 adopt --pack next-react
```
