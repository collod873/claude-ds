...
```sh
npx github:collod873/claude-ds#v1.5.1
```
...
npx github:collod873/claude-ds#v1.5.1 init --pack next-react

# Brownfield — adopt into an existing project
npx github:collod873/claude-ds#v1.5.1 adopt --pack next-react
```
