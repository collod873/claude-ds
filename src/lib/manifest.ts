...
export function parseManifest(raw: string): Manifest {
  const o = JSON.parse(raw) as { files?: unknown; canonical_paths?: unknown; lookalike_ignore?: unknown; deprecated_paths?: unknown; managed_roots?: unknown; generated_patterns?: unknown };
  ...
  const generated_patterns: string[] = Array.isArray(o.generated_patterns)
    ...
    : [];
  return { files: out, canonical_paths, lookalike_ignore, deprecated_paths, managed_roots, generated_patterns };
}
