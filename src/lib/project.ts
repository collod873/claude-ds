...
import { loadConfigWithMigration } from "./paths.js";
...
/**
 * Boot a command: read+migrate `.claude-ds.json`, resolve packDir from this file's
 * location (works in both src/ during dev and dist/ when built), parse the manifest.
 *
