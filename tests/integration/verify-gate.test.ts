...
vi.mock("../../src/lib/log.js", async () => {
  const actual = await vi.importActual<typeof import("../../src/lib/log.js")>(
    "../../src/lib/log.js",
  );
  return {
    ...actual,
...
vi.mock("../../src/lib/run-consumer-verify.js", async () => {
  const actual =
    await vi.importActual<typeof import("../../src/lib/run-consumer-verify.js")>(
...
import { info, err, printNextStep } from "../../src/lib/log.js";
